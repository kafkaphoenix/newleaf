...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(SettingsManager, app_name, root, logfile_path, backtrace_logfile_path,
                                   ...
                                   primary_monitor, vsync, resizable, imgui_window, fit_to_window, cursor_icon_path,
                                   cursor_mode, enable_debug, display_fps, enable_engine_logger, enable_app_logger,
                                   engine_log_level, app_log_level, engine_flush_level, app_flush_level,
                                   enable_engine_backtrace_logger, enable_app_backtrace_logger, clear_color,
                                   clear_depth, active_scene, active_scene_path, reload_prototypes,
                                   display_collision_boxes, default_texture_path);
}